...
import type { EntityHistory, WorldEventRecord } from "./types.js";
...
export class EventGraph {
  ...
  append(event: WorldEventRecord): void {
  ...
  getRecentForEntity(entityId: string, limit = 20): WorldEventRecord[] {
